...
from misc.tweibo.binder import bind_api
from misc.tweibo.error import QWeiboError
from misc.tweibo.parsers import ModelParser
from misc.tweibo.utils import convert_to_utf8_bytes, mulitpart_urlencode
...
class API(object):
    ...
    def _pack_image(filename, contentname, max_size=1024, **params):
        ...
        BOUNDARY = 'QqWeIbObYaNdElF----'  # misc.tweibo by andelf
        body = []
