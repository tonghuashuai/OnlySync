...
from misc.tweibo.compat import Request, urlopen, quote, urlencode
from misc.tweibo.error import QWeiboError
from misc.tweibo.utils import convert_to_utf8_str
...
def bind_api(**config):
    ...
    class APIMethod(object):
        ...
        def execute(self):
            ...
            self.headers.setdefault("User-Agent", "pymisc.qqweibo")
            if self.method == 'POST':
